...
Atafaq.run(function($ionicPlatform, $state, $rootScope,$cordovaGeolocation) {
            ...
            $cordovaGeolocation
                ...
                .then(function (position) {
                    ...
                    $.getJSON(GEOCODING).done(function(location) {
                        $rootScope.loc=location.results[3].address_components[1].long_name;
//                      alert($rootScope.loc);
                    })
                }, function(err) {
...
Atafaq.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
    $stateProvider
